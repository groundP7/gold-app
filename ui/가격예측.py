...
def run_ml():
    ...
    if predict_button:
        ...
        st.info("📸 Plotly 그래프의 카메라 버튼을 클릭하면 그래프를 다운로드할 수 있습니다.")
        st.info("예측 금액은 EXchange-rate AIP를 이용하여 실시간환율 정보를 가져와서 보여줍니다.")
        # 예측 결과 출력
        st.subheader("📊 예측 결과")
